...
export const Contact = () => {
  return (
    <motion.div
      ...
      <div className='w-1/2 w-10/12 h-full flex items-center justify-center flex-col'>
        <h1 className='font font-sans'>Contact</h1>
        <form className='w-full max-w-md flex justify-evenly items-center flex-col h-1/2' action="https://api.web3forms.com/submit" method="POST">
